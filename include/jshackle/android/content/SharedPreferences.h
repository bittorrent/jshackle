...
JSHACKLE_JAVA_CLASS_BEGIN(SharedPreferences);
    JSHACKLE_JAVA_CLASS_BEGIN(Editor);
        ...
        JSHACKLE_JAVA_CLASS_METHOD(jshackle::JavaClassRef<Editor>, remove, const std::string&);

        JSHACKLE_JAVA_CLASS_METHOD(jshackle::JavaClassRef<Editor>, putString, const std::string&, const std::string&);
        JSHACKLE_JAVA_CLASS_METHOD(jshackle::JavaClassRef<Editor>, putInt, const std::string&, int);
        JSHACKLE_JAVA_CLASS_METHOD(jshackle::JavaClassRef<Editor>, putLong, const std::string&, long long);
        JSHACKLE_JAVA_CLASS_METHOD(jshackle::JavaClassRef<Editor>, putFloat, const std::string&, float);
        JSHACKLE_JAVA_CLASS_METHOD(jshackle::JavaClassRef<Editor>, putBoolean, const std::string&, bool);
